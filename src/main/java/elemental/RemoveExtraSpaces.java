...
public class RemoveExtraSpaces {
	...
	private static void removeSpaces1(String inputString) {
		...
		System.out.println("Actual dsa.string: " + inputString);

		System.out.println("After dsa.string: " + stringBufferObj.toString().trim());
	...
	private static void removeSpaces2(String inputString) {
		...
		System.out.println("After dsa.string: " + afterString);
