...
public class OccurencesOfElementsInArray {
	...
	public static void main(String[] args) {
		...
		System.out.println("Please enter size of dsa.array");
		...
		// at a certain index of userInputArrayObj[] dsa.array
		int i, temp = 0;

		System.out.println("Enter the integers between 1 and " + size);

		// Initialize userInputArrayObj[] dsa.array with user input
		...
		// Value at a given index of userInputArrayObj dsa.array
		// will be stored in temp variable
		// temp variable will act as an index value
		// for elementsCountArrayObj dsa.array and keep track of number
