...
public class FindMiddleIndexWhenSumOfBothSidesEqual {
	...
	public static int findMiddleIndexMethod(int[] arr) {
		...
		// Here first we traverse the dsa.array once to find total sum of dsa.array,
	...
	public static void main(String[] args) {
		...
		System.out.print("Middle index of the dsa.array when both ends sums equal: " + middleIndexObj);
	}
}
